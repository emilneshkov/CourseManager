...
Teacher::Teacher(int id, const MyString& firstName, const MyString& lastName, const MyString& email, const MyString& defaultPass) : User(id, firstName, lastName, MyString(), defaultPass, MyVector<Message>(), Role::Teacher)
{
}